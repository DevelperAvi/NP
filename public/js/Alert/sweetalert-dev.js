...
var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = require('./modules/handle-Message-dom');
...
sweetAlert = Message = function () {
  ...
  switch (typeof customizations) {
    // Ex: Message("Hello", "Just testing", "info");
    case 'string':
    ...
    // Ex: Message({ title:"Hello", text: "Just testing", type: "info" });
    case 'object':
 ...
 */
sweetAlert.setDefaults = Message.setDefaults = function (userParams) {
  if (!userParams) {
 ...
 */
sweetAlert.close = Message.close = function () {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.showInputError = Message.showInputError = function (errorMessage) {
  var modal = _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition.getModal();
 ...
 */
sweetAlert.resetInputError = Message.resetInputError = function (event) {
...
if (typeof window !== 'undefined') {
  ...
  window.sweetAlert = window.Message = sweetAlert;
} else {
  _extend$hexToRgb$isIE8$logStr$colorLuminance.logStr('SweetAlert is a frontend module!');
}
},{"./modules/default-params":2,"./modules/handle-click":3,"./modules/handle-dom":4,"./modules/handle-key":5,"./modules/handle-Message-dom":6,"./modules/set-params":8,"./modules/utils":9}],2:[function(require,module,exports){
'use strict';
...
var _getModal = require('./handle-Message-dom');
...
module.exports = exports['default'];
},{"./handle-dom":4,"./handle-Message-dom":6,"./utils":9}],4:[function(require,module,exports){
'use strict';
...
var _setFocusStyle = require('./handle-Message-dom');
...
module.exports = exports['default'];
},{"./handle-dom":4,"./handle-Message-dom":6}],6:[function(require,module,exports){
'use strict';
...
var _getModal$getInput$setFocusStyle = require('./handle-Message-dom');
    ...
    var _ret = (function () {
      ...
      switch (params.type) {
        ...
        case 'prompt':
          ...
          setTimeout(function () {
            $input.focus();
            $input.addEventListener('keyup', Message.resetInputError);
          }, 400);
          break;
      }
    })();
...
module.exports = exports['default'];
},{"./handle-dom":4,"./handle-Message-dom":6,"./utils":9}],9:[function(require,module,exports){
'use strict';
